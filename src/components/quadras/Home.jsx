...
export default function Home() {
  return <div className={styles.container}>
    <main className={`${styles.app} ${styles.homePage}`}>
      <div className={styles.contentCard}>
        <header className={styles.hero}>
          ...
          <div className={styles.heroActions}><Link to="/agendar-horario" className={styles.primaryAction}>🕐 Agendar horário</Link><Link to="/quadras" className={styles.secondaryAction}>🏐 Ver quadras</Link></div>
        </header>
